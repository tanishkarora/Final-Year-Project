...
export const Predict = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result == 0.0) {
        setResult("The probablity of the student to adapt to online mode of education is: High");
        // eslint-disable-next-line
      } else if (result == 1.0) {
        setResult("The probablity of the student to adapt to online mode of education is: Low");
        // eslint-disable-next-line
      } else if (result == 2.0) {
        setResult("The probablity of the student to adapt to online mode of education is: Moderate");
      } else {
        setResult("Unknown");
      }
    } catch (error) {
